WITH artist_base_cte AS (
    SELECT
        ...
        , l.longitude
        , ROW_NUMBER()
            OVER (PARTITION BY a.artist_id ORDER BY a.artist_popularity DESC, l.country_code DESC)
            AS artist_sort
    ...
    SELECT
        ...
        , l.longitude
        , ROW_NUMBER()
            OVER (PARTITION BY u.artist_name ORDER BY u.count_played DESC, l.country_code DESC)
            AS artist_sort
