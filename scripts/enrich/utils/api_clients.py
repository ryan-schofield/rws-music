...
class SpotifyAPIClient:
    ...
    def get_artists_batch(self, artist_ids: List[str], batch_size: int = 50) -> List[Dict[str, Any]]:
    ...
    def get_albums_batch(self, album_ids: List[str], batch_size: int = 20) -> List[Dict[str, Any]]:
...
class MusicBrainzClient:
    ...
    def __init__(self, user_agent: str = "fffv_tracks_history/0.1", cache_dir: str = None):
    ...
    def get_artist_by_isrc(self, isrc: str) -> Optional[str]:
        ...
        try:
            ...
            return recording["isrc"]["recording-list"][0]["artist-credit"][0]["artist"]["id"]
        except Exception as e:
            logger.warning(f"Could not find artist for ISRC {isrc}: {e}")
            return None
    
    def get_artist_by_id(self, artist_mbid: str, includes: List[str] = None) -> Optional[Dict[str, Any]]:
    ...
    def get_area_by_id(self, area_id: str, includes: List[str] = None) -> Optional[Dict[str, Any]]:
